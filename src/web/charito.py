...
def _build_card(item: Dict[str, Any]) -> html.Div:
    ...
    badge_cls = "charito-status-badge"
    if status_raw == "offline":
        card_cls.append("charito-card-stale")
        badge_cls += " charito-status-badge--stale"
    ...
    header = html.Div(
        ...
        children=[
            ...
            html.Span(f"Estado: {status_label}", className=badge_cls),
        ],
    )
    ...
    averages = html.Div(
        ...
        children=[
            html.Div("Promedio", className="charito-section-title"),
            html.Div(
                className="charito-metric-pair",
                children=[
                    html.Div(
                        className="charito-metric",
                        children=[
                            html.Div("CPU", className="charito-metric-label"),
                            html.Div(avg_cpu, className="charito-metric-value"),
                        ],
                    ),
                    html.Div(
                        className="charito-metric",
                        children=[
                            html.Div("Memoria", className="charito-metric-label"),
                            html.Div(avg_mem, className="charito-metric-value"),
                        ],
                    ),
                ],
            ),
    ...
    latest_section = html.Div(
        className="charito-section",
        children=[
            html.Div("Última muestra", className="charito-section-title"),
            html.Div(
                className="charito-metric-pair",
                children=[
                    html.Div(
                        className="charito-metric",
                        children=[
                            html.Div("CPU instantánea", className="charito-metric-label"),
                            html.Div(latest_cpu, className="charito-metric-value"),
                        ],
                    ),
                    html.Div(
                        className="charito-metric",
    ...
    return html.Div(
        ...
        children=[header, averages, latest_section, process_section],
    )
