...
class logs():
    ...
    def logs_console_print(self, func: str, reason: str, desc: str) -> None:
        ...
        self.logger.log(f"{func} ~ ( {reason} ): {desc}.", origen="LOGS")
    ...
    def logs_logo_print(self, logo: str, version: str) -> None:
        ...
        self.logger.log(f"Imprimiendo logo de la version {version}", origen="LOGS")
    ...
    def logs_load_process_print(self) -> None:
        ...
        self.logger.log("Proceso de carga en curso...", origen="LOGS")