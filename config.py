...
# ---------------------------------------------------------
ALARM_EMAIL_RECIPIENT = ["yo@email.com"]
ALARM_EMAIL_SENDER = "tu@email.com"    # Remitente del email (generalmente debe coincidir con SMTP_USERNAME)
ALARM_EMAIL_SUBJECT_PREFIX = "[Exemys] "        # Prefijo para el asunto del email

# Detalles del servidor SMTP
SMTP_SERVER = "post.email.com" 
SMTP_PORT = 587             # Puerto estándar para TLS (587) o SSL (465). Si no estás seguro, prueba 587 primero.
SMTP_USERNAME = "usr@dominio.com"
SMTP_PASSWORD = "usr"
...
# --- MQTT ------------------------------------------------
# ---------------------------------------------------------
MQTT_BROKER_HOST = "mibroker"
MQTT_BROKER_PORT = 8883
MQTT_BROKER_USERNAME = "user"
MQTT_BROKER_PASSWORD = "pass"
MQTT_USE_TLS = True                 # Usar TLS/SSL para la conexión
MQTT_ESTADO_EXEMYS = "estado/exemys"
MQTT_ESTADO_EMAIL = "estado/email"
MQTT_TOPIC_SENSOR = "estado/sensor"
